...
##--------------------------------------------------------------------------------------------------------------------------
module "iam-role" {
  source = "git::https://github.com/Shanav-Technologies/terraform-aws-iam-role.git?ref=v1.0.0"
...
module "pritunl" {
  ...
  #Keypair
  public_key = "sshxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxZwwpt8vRt roshan@roshan"
